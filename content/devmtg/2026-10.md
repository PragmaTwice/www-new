---
title: "2026 US LLVM Developers' Meeting"
description: ""
date: 2026-04-27T20:01:36Z
toc: true
tags: []
draft: false
---
...
Registration is open on the [event website](https://llvm.swoogo.com/2026devmtg/register).

## About

The US LLVM Developers' Meeting is a bi-annual gathering of the entire LLVM Project community. The conference is organized by the LLVM Foundation and many volunteers within the LLVM community. Developers and users of LLVM, Clang, and related subprojects will enjoy attending interesting talks, impromptu discussions, and networking with the many members of our community. Whether you are a new to the LLVM project or a long time member, there is something for each attendee.

Information regarding call for proposals and call for workshops will be released in the coming weeks.
...
All developers and users of LLVM and related sub-projects are invited to present at the 2026 US LLVM Developers’ Meeting in Santa Clara, California! This conference will be held in-person October 26-28.

Submission deadlines will be announced on a future date.

There are a variety of talk proposals we accept:

- Technical Talks (20 minutes): Talks on LLVM infrastructure, Clang and all related sub-projects, uses of LLVM in academia or industry, new projects using Clang or LLVM, and LLVM community topics.
...
To be announced on a future date.

Discounted registration is provided to one speaker for these types of talks:
...
- Abstract
- Submission type
- Photo and bios for all speakers (required). Please do not put authors here,
  as this is used by the A/V and logistics team for A/V requirements.
...
- For technical talk submissions, you can indicate if you would give a shorter
  talk (for example, Lightning or Quick instead of a full-length Technical Talk)
...
The LLVM Foundation has a student grant program. Learn more here:

More information coming soon.

The deadline for 2026 applications is to be announced.
...
- Financial need
- Priority may be given to those presenting a paper or work using LLVM or a
  related sub-project at the conference or workshop.
- Priority may be given to underrepresented backgrounds, genders, and
  experiences to encourage broader participation in computer science and
  engineering.
...
- Not be an LLVM Foundation director, officer, or employee, or a relative of
  any LLVM Foundation director, officer, or employee.
- Residents of India must have a bank account in another country that accepts
  wire transfers.
- Not be a resident of an embargoed country.

Selection Process

- Applications will be accepted by the posted application deadlines on the
  LLVM Foundation website.
- Applicants are responsible for gathering and submitting all necessary
  information on the application form. Incomplete applications will not be
  considered.
- All information received from the applicant will be treated as confidential
  and will not be shared outside of the LLVM Foundation except as required by
  governmental regulations such as IRS reviews of the LLVM Foundation’s Grant
  Program.
- Successful applicants will be notified and given a grant letter, to be
  signed and returned to the LLVM Foundation.

Award Amounts

- All awards include a developers' meeting ticket and hotel accommodation.
...
If you have any questions, please [email bwatson@llvm.org](mailto:bwatson@llvm.org)
